...
public class App {
	public static void main(String[] args) {
		...
		WhatToDoVisitor v = new WhatToDoVisitor();
		v.register(Reporter.class, new ReporterToDo());
		v.register(Editor.class, new EditorToDo());
		v.register(EditorInChief.class, new EditorInChiefToDo());
